...
const Header = ({
  ...
  return (
    <nav className="bg-gray-800 w-full p-4 flex flex-col items-center">
      <form onSubmit={handleCreateList} className="flex flex-col items-center w-full mb-4">
        <input
          type="text"
          value={listName}
          onChange={(e) => setListName(e.target.value)}
          className="px-4 py-2 text-lg text-gray-700 bg-white border border-solid border-gray-300 rounded transition ease-in-out focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none w-full max-w-md mb-2"
          placeholder="New list name..."
        />
        ...
        <button
          type="submit"
          className="px-4 py-2 bg-green-600 text-white font-medium text-lg rounded shadow-md hover:bg-green-700 focus:bg-green-700 focus:outline-none transition duration-150 ease-in-out w-full max-w-md"
        >
          Create List
        </button>
      </form>
      ...
      >
        ...
        <button
          type="submit"
          className="px-4 py-2 bg-blue-600 text-white font-medium text-lg rounded shadow-md hover:bg-blue-700 focus:bg-blue-700 focus:outline-none transition duration-150 ease-in-out w-full max-w-md"
        >
          Search
        </button>
      </form>
